...
function About() {
  ...
  return (
    <div className='about-container'>
      ...
      <p>I am an aspiring full-stack developer currently in a React bootcamp with the will to be the best I can be with my current experience and my great attention to details.</p>
      <p>My goal is to find the challenge in order to improve more in this field that I am passionate about.</p>
      <p>My favortie technologies are :</p>
      <div className='icon-container'>
        {iconList.map((item, index) => (<DevIcons key={index} {...item} />))}
      </div>
